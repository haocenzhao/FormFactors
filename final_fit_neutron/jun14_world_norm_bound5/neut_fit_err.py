...
#fitmax2 = 20
#fitmax2 = int(raw_input('-- How many parameters? '))
...
axes[0][0].set_ylabel('$log10(dG_E^n/G_D)$', fontsize=30)
...
axes[1][0].set_ylabel('$dG^n_E(fit)/dG^n_E(data)$', fontsize=30)
...
axes[0][1].set_ylabel('$log10(dG_M^n/G_D)$', fontsize=30)
...
axes[1][1].set_ylabel('$dG^n_M(fit)/dG^n_M(data)$', fontsize=30)
