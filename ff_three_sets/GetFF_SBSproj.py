...
def GetFF(kID, kQ2):# {{{
    ...
    # GEp (SBS-projected update) 01/28/2026 by H. Zhao
    ...
    # GMp (SBS-projected update) 01/28/2026 by H. Zhao
    MU_P = 2.792847356
    ...
    # GEn (SBS-projected update, z7) 01/28/2026 by H. Zhao 
    GN_Coef_Fit[2] = np.array([
        0.04909416788606062, -0.06333666947442218, -0.2429047972144268, 
        0.38535451706367096, 0.3155691723651585, -0.6538938759720998, 
        -0.21867349424895097, 0.6464899257172427, -0.042255627541084806, 
        -0.27936509472530524, 0.10392177614415754, 0.0, 0.0
    ]) #GEn
